      ...
      <Section ref={ref} id="shop">
        <Right ref={horizontalRef}>
          ...
          <Product
            video={video1}
            title="Hero Section"
            detail="I used a neon color 3d cylinder shape as the background for hero section. The bottom part is in a beautiful arch, utilizing geometric aesthetic. The wallet connect button is in a bright color as well, I also added inner and outer shadow to create a more neon effect. The scattered around NFTs moves around the 3d avatar. This design is inline with the project's main goal: to create a more customised and immersive NFT experience."
          />
          <Product
            img={img1}
            title="Wallet Connection"
            detail="I created a glass morphism effect for the wallet connect modal panel. All the texts have neon effect."
          />
          <Product
            video={video2}
            title="Function Introduction"
            detail="I created a neon bordered transparent panel, to work with the glass morphism effecr for each individual NFT card. The colorful geometry shapes in the background add an extra layer of dynamic for the section."
          />
          <Product
            video={video3}
            title="Search & Display"
            detail="Search and Display area is made of one fully customised neon search bar and the top 10 best matched results for the keyword. Each individual NFT is surrounded with neon transparent card, which creates a fantasy vibe."
          />
          <Product
            video={video4}
            title="Footer"
            detail="For the footer section, a customised SVG shape is used, and the changing color effect is to work with the changing color effect at the hero section. All the individual social icons are surrounded with neon light effect as well to align with the overall effect of the website."
          />
        </Right>
      </Section>
    </div>
